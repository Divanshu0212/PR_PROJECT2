    ...
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        {resume.work.map((w, wi) => (
          <div key={wi} className="rounded-sm border border-hairline bg-white/60 p-3">
            ...
            <ul className="mt-2 space-y-1.5">
              {w.bullets.map((b, bi) => (
                <li key={bi} className="flex items-start gap-1.5">
                  ...
                  <textarea
                    className="w-full resize-none rounded-sm border border-transparent bg-transparent p-1 text-sm leading-snug text-ink outline-none transition-colors hover:border-hairline focus:border-studio focus:bg-white"
